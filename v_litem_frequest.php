...
<body>
  ...
  <div class="container">
    <div class="row mt-3 mb-1">
        <div class="col"><p class="h2 p-1  bg-primary w-50 rounded text-center text-white">遺失物捜索依頼</p></div>
    </div>
    <div class="row">
        <div class="col">
        <p class="bg-light p-1 border m-0">遺失物捜索依頼画面では，文教大学湘南キャンパスでモノを無くしてしまった場合に，その物品の情報を入力するための画面です．必要事項を入力の上で登録を選択してください．登録が完了すると，その情報は検索の対象となります．</p>
            <hr>
      </div>
    </div>
    ...
    <div class="row">
        <div class="col mt-1">
            ...
            <table>
                <tr><td>遺失物分類</td><td><select class="category" name="p1"></select></td></tr>
                <tr><td>遺失場所</td><td><input type="text" required class="form-control" name="p2"></td></tr>
